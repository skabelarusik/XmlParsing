...
public class DomParcerToursTest {
    ...
    public void testBuildTours(){
        try {
           parserAbstract = TouristVoucherParcerFactory.getInstance().createParser(TypeParserFactory.DOM);
           parserAbstract2 = TouristVoucherParcerFactory.getInstance().createParser(TypeParserFactory.DOM);
