...
public class StaxParserToursTest {
    ...
    public void testBuildTours(){
        try {
            parserAbstract = TouristVoucherParcerFactory.getInstance().createParser(TypeParserFactory.STAX);
            parserAbstract2 = TouristVoucherParcerFactory.getInstance().createParser(TypeParserFactory.STAX);
